...
@Component({
  selector: 'mereka-onboarding-expertise',
  standalone: true,
  imports: [CommonModule, FormsModule, OnboardingShellComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <mereka-onboarding-shell kind="Expertise" title="Offer your expertise" [steps]="steps" [active]="active()" (activate)="active.set($event)">
...
export class OnboardingExpertisePage {
