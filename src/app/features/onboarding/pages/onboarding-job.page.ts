...
@Component({
  selector: 'mereka-onboarding-job',
  standalone: true,
  imports: [CommonModule, FormsModule, OnboardingShellComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <mereka-onboarding-shell kind="Gig" title="Post a gig" [steps]="steps" [active]="active()" (activate)="active.set($event)">
...
export class OnboardingJobPage {
