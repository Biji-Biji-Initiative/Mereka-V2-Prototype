...
@Component({
  selector: 'mereka-onboarding-experience',
  standalone: true,
  imports: [CommonModule, FormsModule, OnboardingShellComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <mereka-onboarding-shell kind="Experience" title="Host your first experience" [steps]="steps" [active]="active()" (activate)="active.set($event)">
...
export class OnboardingExperiencePage {
